...
def test_solicitation_sources_route_and_degradation():
    # /sources must resolve (not be parsed as /{id}) and degrade to [] sans DB.
    r = client.get("/api/solicitations/sources")
    assert r.status_code == 200 and r.json() == []
