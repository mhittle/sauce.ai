...
## Step 3 — Architecture in one paragraph
...
## Step 5 — When you accomplish something meaningful, append to `engineering-history.md`
...
## Step 6 — Known sharp edges to watch for
...
3. Do the work on a feature branch, open a PR.
4. When something meaningful lands, append a new section to
