...
## Condensed on 2026-05-31 — verbatim 2026-05-22 live entries

Moved here when the live file exceeded its single-read budget on
2026-05-31. The live file keeps tight summaries under "Condensed
history"; all load-bearing server state from these entries lives in
the live file's "Load-bearing production state" / "Applied prod schema
migrations" sections and in `manual-actions.md` Completed.
...
## Condensed on 2026-05-31 — verbatim 2026-05-22 live entries (unique-sources, demand-driven classify, fold-keywords, fleet observability, fleet hardening)

Moved here when the live file exceeded its single-read budget on 2026-05-31. The live file keeps short summaries; operational reference for the fleet items is `agent-fleet.md`.
